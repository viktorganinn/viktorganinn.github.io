function start(n) {
    if (n == 1) {
        if (document.getElementById('sym-o').className != 'choose-sym-o-dis') {
    document.getElementById('sym-x').disabled = true;
    document.getElementById('sym-x').className = 'choose-sym-x-dis';
    document.getElementById('sym-o').disabled = true;
    document.getElementById('cross').checked = true;
    document.getElementById('zero').checked = false;
        }
    }
    if (n == 2) {
        if (document.getElementById('sym-x').className != 'choose-sym-x-dis') {
        document.getElementById('sym-x').disabled = true;
        document.getElementById('sym-o').className = 'choose-sym-o-dis';
        document.getElementById('sym-o').disabled = true;
        document.getElementById('zero').checked = true;
        document.getElementById('cross').checked = false;
        }  
    }
    document.getElementById('tie').className = 'result-notseen';
    document.getElementById('x-win').className = 'result-notseen';
...
if (counter == 9) {
    document.getElementById('tie').className = 'result-seen';
    startAgain();
}
}
function startAgain() {
    ...
    document.getElementById('cross').checked = false;
    document.getElementById('zero').checked = false;
    document.getElementById('sym-x').disabled = false;
    document.getElementById('sym-o').disabled = false;
    document.getElementById('sym-x').className = 'choose-sym-x';
    document.getElementById('sym-o').className = 'choose-sym-o';
}